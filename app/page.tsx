  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
      ...
      <div className="lg:col-span-2 space-y-8">
        ...
        <div className={`space-y-8 transition-opacity duration-300 ${isChangingPage ? 'opacity-0' : 'opacity-100'}`}>
      ...
      <div className="lg:col-span-1">
        <FadeIn delay={200}>
          <div className="glass-effect rounded-xl p-8 sticky top-24 relative group">
